            ...
            <div class="box grid">
                ...
                <div class="box_body">
                    ...
                    <table width=100%>
                        ...
                        <tr>
                            <td width=50% align=center><div>The cao doi tac</div><div><iframe height="350px" width="100%" frameBorder="0" src="rev_data.php?type=4">your browser does not support IFRAMEs</iframe></div></td>
                            <td width=50% align=center><div>SMS doi tac</div><div><iframe height="350px" width="100%" frameBorder="0" src="rev_data.php?type=2">your browser does not support IFRAMEs</iframe></div></td>
                        </tr>
