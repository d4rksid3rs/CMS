...
$to_date = isset($_REQUEST['to_date']) ? trim($_REQUEST['to_date']) : '2015-06-20';
$to_time = !empty($_REQUEST['to_time']) ? trim($_REQUEST['to_time']) : '23:59:59';
$factor = isset($_REQUEST['factor']) ? (float) ($_REQUEST['factor']) : 1.0;
// card 1
$from_date2 = isset($_REQUEST['from_date2']) ? trim($_REQUEST['from_date2']) : '2015-06-20';
...
// card 2
$from_date3 = isset($_REQUEST['from_date3']) ? trim($_REQUEST['from_date3']) : '2015-06-20';
...
// iap 1
$from_date4 = isset($_REQUEST['from_date4']) ? trim($_REQUEST['from_date4']) : '2015-06-20';
$from_time4 = !empty($_REQUEST['from_time4']) ? trim($_REQUEST['from_time4']) : '00:00:00';
$to_date4 = isset($_REQUEST['to_date4']) ? trim($_REQUEST['to_date4']) : '2015-06-20';
...
// iap 2
$from_date5 = isset($_REQUEST['from_date5']) ? trim($_REQUEST['from_date5']) : '2015-06-20';
$from_time5 = !empty($_REQUEST['from_time5']) ? trim($_REQUEST['from_time5']) : '00:00:00';
$to_date5 = isset($_REQUEST['to_date5']) ? trim($_REQUEST['to_date5']) : '2015-06-20';
...
if ($row = mysql_fetch_assoc($result)) {
    ...
    if (!empty($value)) {
        ...
        // iap
        $from_date4 = !empty($arr['iap']['from_date']) ? $arr['iap']['from_date'] : '';
        $arr1 = explode(' ', $from_date4);
        $from_date4 = $arr1[0];
        $from_time4 = $arr1[1];
        $to_date4 = !empty($arr['iap']['to_date']) ? $arr['iap']['to_date'] : '';
        $arr1 = explode(' ', $to_date4);
        $to_date4 = $arr1[0];
        $to_time4 = $arr1[1];
        $factor4 = !empty($arr['iap']['factor']) ? $arr['iap']['factor'] : $ratio_presets;
        // iap 2
        $from_date5 = !empty($arr['iap2']['from_date']) ? $arr['iap2']['from_date'] : '';
        $arr1 = explode(' ', $from_date5);
        $from_date5 = $arr1[0];
        $from_time5 = $arr1[1];
        $to_date5 = !empty($arr['iap2']['to_date']) ? $arr['iap2']['to_date'] : '';
